...
from pm4py.algo.conformance.alignments.petri_net.algorithm import VERSION_STATE_EQUATION_A_STAR
...
def __calculate_optimal_alignment(pt: ProcessTree, trace: Trace, version=VERSION_STATE_EQUATION_A_STAR):
    ...
    return calculate_alignments(trace, net, im, fm, parameters={'ret_tuple_as_trans_desc': True}, variant=variants_calculate_alignments.state_equation_a_star)
